...
throw new Error("Module parse failed: /Users/fangdiao/Projects/schoolWeike/src/js/components/applyProjectBox.js The keyword 'let' is reserved (29:4)\nYou may need an appropriate loader to handle this file type.\n|   },\n|   show: function() {\n|     let this.projectName = $(target).parents(\".project-box\").find(\".p-name\").html();\n|     let topHeight = $(document).scrollTop() + 200;\n|     $(\".index .sendProject\").html(\"项目名 : \" + projectName);");
...
const rotation_str = __webpack_require__(56);
...
module.exports = "<ul>\n  <li><a href=\"javascript:void(0);\"><img src=\"" + __webpack_require__(57) + "\" alt=\"1\"></a></li>\n  <li><a href=\"javascript:void(0);\"><img src=\"" + __webpack_require__(58) + "\" alt=\"2\"></a></li>\n  <li><a href=\"javascript:void(0);\"><img src=\"" + __webpack_require__(59) + "\" alt=\"3\"></a></li>\n  <li><a href=\"javascript:void(0);\"><img src=\"" + __webpack_require__(60) + "\" alt=\"4\"></a></li>\n  <li><a href=\"javascript:void(0);\"><img src=\"" + __webpack_require__(61) + "\" alt=\"5\"></a></li>\n</ul>\n<div class=\"icon\">\n  <span class=\"active\"></span>\n  <span></span>\n  <span></span>\n  <span></span>\n  <span></span>\n</div>\n<div class=\"to-left\">\n  <i class=\"iconfont\">&#xe618;</i>\n</div>\n<div class=\"to-right\">\n  <i class=\"iconfont\">&#xe61c;</i>\n</div>";
...
const index_str = __webpack_require__(42);
const rotation = __webpack_require__(54);
const content_path = __webpack_require__(1);
const rotation_go = new rotation();
const applyProjectBox = __webpack_require__(52);
  				...
  				if(res.ifSuccess){
  					const moduleRow = $('.pro-box');
						for (let i = 0;i < 16;i ++) {
				          ...
				          <a href="details.html?${res.data[i].projectName}" target='_blank'>
				            <div class="clearfix">
				              <p>项目名称:</p>
