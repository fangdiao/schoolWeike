...
var cut_picture_str = __webpack_require__(56);
function cutPicture () {};
...
//获取技能盒子组件
const skillBox = __webpack_require__(9);
const skill_box = new skillBox();
//获取图片裁剪组件
const cutPicture = __webpack_require__(54);
const cut_picture = new cutPicture();
//获取register页面的html模板
const register_str = __webpack_require__(46);
//请求路径
...
var $ = __webpack_require__(0);
var skill_box_str = __webpack_require__(7);
function skill () {};
skill.prototype = {
  //需要频繁操作的技能盒子
  box: null,
