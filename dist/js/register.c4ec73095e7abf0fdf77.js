...
var $ = __webpack_require__(0);
var skill_box_str = __webpack_require__(31);
function skill () {};
skill.prototype = {
  //需要频繁操作的技能盒子
  box: null,
...
var $ = __webpack_require__(0);
var cut_picture_str = __webpack_require__(52);
function cutPicture () {};
...
//获取技能盒子组件
const skillBox = __webpack_require__(34);
const skill_box = new skillBox();
//获取图片裁剪组件
const cutPicture = __webpack_require__(49);
const cut_picture = new cutPicture();
//获取register页面的html模板
const register_str = __webpack_require__(42);
//请求路径
const content_path = __webpack_require__(3);
(function () {
var register = {
    ...
    upStudentFrom:function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data.ifSuccess) {
            localStorage.weikeData.data.isCompleted = true;
            if (localStorage.weikeUser) {
              alert('个人信息修改成功，返回主页');
            } else {
              alert('个人信息填写成功，返回主页');
