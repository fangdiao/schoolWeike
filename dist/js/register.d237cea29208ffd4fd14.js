...
var skill_box_str = __webpack_require__(16);
function skill () {};
skill.prototype = {
  //需要频繁操作的技能盒子
  box: null,
...
//获取技能盒子组件
const skillBox = __webpack_require__(17);
const skill_box = new skillBox();
//获取图片裁剪组件
const cutPicture = __webpack_require__(52);
const cut_picture = new cutPicture();
//获取register页面的html模板
const register_str = __webpack_require__(43);
//请求路径
