...
const content_path = __webpack_require__(3);
var list_str = __webpack_require__(44);
					...
					if (response.ifSuccess) {
						...
						for (let i = 0; i < dataLength; i++) {
							let module = `<div class="col-xs-12 col-sm-6 col-md-3 project-box">
								<a href="details.html?projectName=${res.data[i].projectName}>
									<div class="clearfix">
										<p>项目名称:</p>
		...
		searchClick:function() {
			$('body').on('click','.search',function(event){
				...
				if(target.hasClass('iconfont')){
					...
					window.open("release.html", "_self", "scrollbars = 1");
				} else if (target.hasClass('join')) {
					applyProjectBox.show(event.target);
				}
			});
		},
