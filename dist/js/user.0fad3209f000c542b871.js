...
module.exports = "<div class=\"common-width user\">\n  <div class=\"container clearfix\">\n    <div class=\"row user-content\">\n      <div class=\"col-xs-2\">\n        <ul class=\"menu\">\n          <li class=\"active\">消息中心</li>\n          <li>项目历史</li>\n          <li>个人资料</li>\n          <li>系统中心</li>\n        </ul>\n      </div>\n      <div class=\"col-xs-10\">\n        <div class=\"content\">\n          <div class=\"content-box message\">\n            <div class=\"receive\">\n              <h5>接收的消息</h5>\n              <ul>\n                <li class=\"message-box clearfix\">\n                  <div class=\"clearfix\">\n                    <div class=\"left\">\n                      <p>名字</p>\n                    </div>\n                    <div class=\"right clearfix\">\n                      <p>内容内容内容内容内容内容内容内容内容内容内容</p>\n                    </div>\n                  </div>\n                  <span class=\"delete\"><i class=\"iconfont\">&#xf0008;</i>删除</span>\n                  <span>20170714</span>\n                </li>\n              </ul>\n            </div>\n            <div class=\"send\">\n              <h5>发送的消息</h5>\n              <ul>\n                <li class=\"message-box clearfix\">\n                  <div class=\"clearfix\">\n                    <div class=\"left\">\n                      <p>名字</p>\n                    </div>\n                    <div class=\"right clearfix\">\n                      <p>内容内容内容内容内容内容内容内容内容内容内容</p>\n                    </div>\n                  </div>\n                  <span>20170714</span>\n                </li>\n              </ul>\n            </div>\n          </div>\n          <div class=\"project-history content-box\">\n            <h5>发布过的项目</h5>\n            <ul>\n              <li>\n                <a href=\"details.html\" target='_blank'>da</a>\n              </li>\n              <li>\n                <a href=\"details.html\" target='_blank'>da</a>\n              </li>\n              <li>\n                <a href=\"details.html\" target='_blank'>da</a>\n              </li>\n            </ul>\n          </div>\n          <div class=\"information content-box\">\n            <ul class=\"student\">\n              <li class=\"clearfix\">\n                <h5>用户名</h5>\n                <p class=\"s-username\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>性别</h5>\n                <p class=\"s-sex\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>学历</h5>\n                <p class=\"s-edu\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>学校</h5>\n                <p class=\"s-university\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>专业</h5>\n                <p class=\"s-major\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>入学时间</h5>\n                <p class=\"s-entry\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>毕业时间</h5>\n                <p class=\"s-leave\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>qq</h5>\n                <p class=\"s-qq\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>技能</h5>\n                <p class=\"s-skill\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>项目经验</h5>\n                <p class=\"s-exp\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>自我评价</h5>\n                <p class=\"s-self\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>等级</h5>\n                <p class=\"s-level\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>邮箱</h5>\n                <p class=\"s-email\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n            </ul>\n            <ul class=\"teacher\">\n              <li class=\"clearfix\">\n                <h5>用户名</h5>\n                <p class=\"t-username\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>性别</h5>\n                <p class=\"t-sex\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>学校</h5>\n                <p class=\"t-university\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>学院</h5>\n                <p class=\"t-academy\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>职称</h5>\n                <p class=\"t-rank\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>qq</h5>\n                <p class=\"t-qq\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n              <li class=\"clearfix\">\n                <h5>邮箱</h5>\n                <p class=\"t-email\">内容内容内容内容内容内容内容内容内容内容内容</p>\n              </li>\n            </ul>\n          </div>\n          <div class=\"system content-box\">\n            <h5>敬请期待!</h5>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n";
...
var weikeData = localStorage.weikeData ? JSON.parse(localStorage.weikData) : false;
	...
	get: function() {
		...
		$.ajax({
			...
			beforeSend:function(request) {
				request.setRequestHeader("Authorization", weikeData.data.token);
			},
...
var getInformation = {
	...
	get: function() {
		...
		$.ajax({
			...
			success: function(response) {
				this.projectToDom(response.data);
			},
			error: function(err){
				console.log(err)
			}
	...
	informtionToDom: function(data) {
		...
		if (weikeData.data.role === 'ROLE_STUDENT') {
			...
			$('s-sex').text(data.sex);
			$('s-edu').text(data.eduBackgroud);
			$('s-university').text(data.university);
			$('s-major').text(data.majorAndGrade);
			$('s-entry').text(data.entryUniversity);
			$('s-leave').text(data.leaveUniversity);
			$('s-qq').text(data.qq);
			$('s-skill').text(data.skills);
			$('s-exp').text(data.experience);
			$('s-self').text(data.selfFeel);
			$('s-level').text(data.level);
			$('s-email').text(data.email);
		} else {
			$('t-username').text(data.username);
			$('t-sex').text(data.sex);
			$('t-university').text(data.university);
			$('t-academy').text(data.academy);
			$('t-rank').text(data.rank);
			$('t-qq').text(data.qq);
			$('t-email').text(data.email);
		}
	}
}
//获取项目
